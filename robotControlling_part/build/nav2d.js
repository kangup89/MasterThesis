...
NAV2D.OccupancyGridClientNav = function(options) {
  ...
  client.on('change', function() {
    ...
    that.base_width = client.currentGrid.width;
    that.base_height = client.currentGrid.height;
    that.base_x = client.currentGrid.pose.position.x;
    that.base_y = client.currentGrid.pose.position.y;

  });
};

NAV2D.CostMapClientNav = function(options) {
  var that = this;
  options = options || {};
  this.ros = options.ros;
  var topic = options.topic || '/map';
